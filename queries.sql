...
-- Q2.which customer use discount but still spent more than average purchase amount?
...
-- Q7.segment customer into New,Returning,Loyal based on their total number of previous purchases and show the count of each segment.
